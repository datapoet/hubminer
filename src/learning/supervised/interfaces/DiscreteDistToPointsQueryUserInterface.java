 ...
 * sets directly, along with the distances to training points. This interface
 * declares the methods for DiscretizedDataInstance classification. There is a
 * corresponding method for continuous valued standard DataInstances as well.
 *
 * @author Nenad Tomasev <nenad.tomasev at gmail.com>
 */
public interface DiscreteDistToPointsQueryUserInterface {

    /**
     * This method performs classification of the target DataInstance.
     *
     * @param instance DiscretizedDataInstance that is to be classified.
