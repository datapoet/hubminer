 ...
 */
public class FastKMeansPlusPlus extends ClusteringAlg {
     ...
     */
    public FastKMeansPlusPlus(DataSet dset, CombinedMetric cmet,
            int numClusters) {
     ...
     * @param numClusters A pre-defined number of clusters.
     */
    public FastKMeansPlusPlus(DataSet dset, int numClusters) {
        setNumClusters(numClusters);
                ...
                do {
                    ...
                    for (int cIndex = 0; cIndex < numClusters; cIndex++) {
                        for (int j = 0; j
                            ...
                            centroids[cIndex].iAttr[j] =
                                    (int) (clusterLinearIntSums[cIndex][j]
