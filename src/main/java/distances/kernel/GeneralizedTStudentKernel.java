 ...
 */
public class GeneralizedTStudentKernel extends Kernel {

    private float d = 1f;

    public GeneralizedTStudentKernel() {
    }

    /**
     * @param d Kernel degree.
     */
    public GeneralizedTStudentKernel(float d) {
        this.d = d;
    }
