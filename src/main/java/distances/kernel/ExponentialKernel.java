...
/**
 * The difference between this and the Gaussian Kernel is that the norm is not
 * squared.
 *
 * @author Nenad Tomasev <nenad.tomasev at gmail.com>
 */
public class ExponentialKernel extends Kernel {

    private float sigma = 0.2f; // Kernel width should be carefully set.
     ...
     */
    public ExponentialKernel(float sigma) {
        this.sigma = sigma;
    }
