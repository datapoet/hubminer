 ...
 */
public class IntraImageKMeansAdapted extends ClusteringAlg {
    ...
    public void clusterOnce() throws Exception {
        ...
        if (numClusters == 1) {
            ...
            do {
                ...
                for (int cIndex = 0; cIndex < numClusters; cIndex++) {
                    centroidColorNeighborhoods[cIndex] = avg.
                            getAverageColorInArray(centroids[cIndex].getX(),
